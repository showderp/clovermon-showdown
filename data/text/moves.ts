export const MovesText: {[k: string]: MoveText} = {
	...
	mondayz: {
		name: "Mondayz",
		desc: "Raises the user's Attack by 12 stages and lowers Speed by 1 in exchange for the user falling asleep for 3 turns. Fails if its Attack stat stage is 6.",
		shortDesc: "Maximizes Attack, -1 Spe, User falls asleep",

		boost: "  [POKEMON] went to sleep and maximized its Attack!",
	},
	fortunatesun: {
		name: "Fortunate Sun",
		shortDesc: "Sets Sunny Day after dealing damage",
	},
	cosmiccrunch: {
		name: "Cosmic Crunch",
		shortDesc: "No additional effect.",
	...
	sentaiblade: {
		name: "Sentai Blade",
		desc: "The user spends two or three turns locked into this move and becomes confused immediately after its move on the last turn of the effect if it is not already. This move targets an opposing Pokemon at random on each turn. If the user is prevented from moving, is asleep at the beginning of a turn, or the attack is not successful against the target on the first turn of the effect or the second turn of a three-turn effect, the effect ends without causing confusion. If this move is called by Sleep Talk and the user is asleep, the move is used for one turn and does not confuse the user. Each hit of this move will lower the opposing Pokemon's Accuracy bt one stage",
		shortDesc: "Lasts 2-3 turns. Confuses the user afterwards, lowers accuracy",
	},
	bigshock: {
		name: "Big Shock",
	...
	kingsvoice: {
		...
		shortDesc: "+1 Sp. Def turn 1. Hits turn 2. 30% to lower Atk.",

		prepare: "[POKEMON] warms up its voice!",
	},
	psychocrusher: {
		name: "Psycho Crusher",
		desc: "If the target lost HP, the user takes recoil damage equal to 33% the HP lost by the target, rounded half up, but not less than 1 HP.",
	...
	kegerdance: {
		name: "Keger Dance",
		desc: "Raises the user's Special Attack by 3 stages, Lowers Speed and confuses the user",
		shortDesc: "+3 Sp. Atk, -1 Spe, Confuses self.",
	},
	canslam: {
		name: "Can Slam",
		desc: "This move can hit a target using Bounce, Fly, or Sky Drop, or is under the effect of Sky Drop. If this move hits a target under the effect of Bounce, Fly, Magnet Rise, or Telekinesis, the effect ends. If the target is a Flying type that has not used Roost this turn or a Pokemon with the Levitate Ability, it loses its immunity to Ground-type attacks and the Arena Trap Ability as long as it remains active. During the effect, Magnet Rise fails for the target and Telekinesis fails against the target.",
	...
	thunderousdrumming: {
		...
		desc: "Has a 60% chance to paralyze the target.",
		shortDesc: "60% chance to paralyze adjacent Pokemon.",
	},
	timebomb: {
		name: "Time Bomb",
		desc: "Deals damage two turns after this move is used. At the end of that turn, the damage is calculated at that time and dealt to the Pokemon at the position the target had when the move was used. If the user is no longer active at the time, damage is calculated based on the user's natural Special Attack stat, types, and level, with no boosts from its held item or Ability. Fails if this move or Future Sight is already in effect for the target's position.",
		...
		start: "  [POKEMON] started counting down!",
		activate: "  [TARGET] exploded!",
	},
	stonehenge: {
		name: "Stonehenge",
		desc: "If this move is successful and the user has not fainted, the effects of Leech Seed and binding moves end for the user, and all hazards are removed from the user's side of the field. Has a 100% chance to raise the user's Speed by 1 stage.",
	...
	jacsmack: {
		name: "Jac Smack",
		desc: "This move's type depends on the user's primary type. If the user's primary type is typeless, this move's type is the user's secondary type if it has one, otherwise the added type from Forest's Curse or Trick-or-Treat. This move is typeless if the user's type is typeless alone.",
		shortDesc: "Type varies based on the user's type and uses the higher attacking stat.",
	},
	serpentskiss: {
		name: "Serpent's Kiss",
		desc: "The user recovers 3/4 the HP lost by the target, rounded half up. If Big Root is held by the user, the HP recovered is 1.3x normal, rounded half down.",
	...
	overthewall: {
		name: "High Jump Kick",
		desc: "If this attack is not successful, the user loses half of its maximum HP, rounded down, as crash damage. Pokemon with the Magic Guard Ability are unaffected by crash damage.",
		shortDesc: "User is hurt by 50% of max HP on miss, Grounds foes.",

		damage: "#crash",
	},
	raindestruction: {
		name: "Raim Destruction",
		desc: "No additional effect.",
		shortDesc: "No additional effect. Hits adjacent Pokemon.",
	},
	supernova: {
		name: "Supernova",
		desc: "Lowers the user's Special Attack.",
		shortDesc: "Lowers the user's Sp. Atk.",
	},
	wingswing: {
		name: "Wing Swing",
	...
	shattershard: {
		...
		start: "  Shatter shards float in the air around [TEAM]!",
		end: "  The shatter shards disappeared from around [TEAM]!",
		damage: "  Shatter shards dug into [POKEMON]!",
	},
	runewrecker: {
		name: "Rune Wrecker",
		desc: "Has a 20% chance to raise a random stat by 2 stages as long as the stat is not already at stage 6.",
		shortDesc: "20% chance to raise a random stat by 2 stages.",
	},
	flamenco: {
		name: "Flamenco",
		desc: "Raises the user's Attack and Speed by 1 stage and also burns the user.",
		shortDesc: "+1 Atk +1 Spe, Burns the user.",
	},
	coomdoom: {
		name: "Coom Doom",
		desc: "Power is equal to (user's current HP * 150 / user's maximum HP), rounded down, but not less than 1.",
	...
	raizehell: {
		name: "Raize Hell",
		shortDesc: "Lowers all of the user's and target's stats.",
	},
	plasmaslasher: {
		name: "Plasma Slasher",
		desc: "Has a higher chance for a critical hit.",
	...
	sloth: {
		name: "Sloth",
		desc: "The user restores 1/2 of its maximum HP, rounded half up. The user will survive attacks made by other Pokemon during this turn with at least 1 HP. This move has a 1/X chance of being successful, where X starts at 1 and triples each time this move is successfully used. X resets to 1 if this move fails, if the user's last move used is not Baneful Bunker, Detect, Endure, King's Shield, Obstruct, Protect, Quick Guard, Spiky Shield, or Wide Guard, or if it was one of those moves and the user's protection was broken. Fails if the user moves last this turn.",
		shortDesc: "Heals the user by 50% and activates Endure",
	},
	beetdown: {
		name: "Beet Down",
		desc: "Power is equal to (user's current HP * 150 / user's maximum HP), rounded down, but not less than 1.",
	...
	fragments: {
		...
		start: "  Pointed bits of steel float in the air around [TEAM]!",
		end: "  The pointed bits of steel disappeared from around [TEAM]!",
		damage: "  Pointed bits of steel dug into [POKEMON]!",
	},
	fragbomb: {
		name: "Frag Bomb",
		desc: "The user faints after using this move, even if this move fails for having no target. This move is prevented from executing if any active Pokemon has the Damp Ability. Also sets fragments hazard on the opponent's side of the field",
		shortDesc: "The user faints, sets fragments on the opponent side.",
	},
	warcry: {
		name: "War Cry",
