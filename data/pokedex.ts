export const Pokedex: { [speciesid: string]: SpeciesData } = {
	...
	photom: {
		...
		name: "Photom",
		types: ["Ghost", "Psychic"],
		baseStats: {hp: 75, atk: 40, def: 140, spa: 80, spd: 140, spe: 75},
	...
	vaximate: {
		...
		abilities: {0: "Poison Touch", 1: "Siphon", H: "Triage"},
		heightm: 3,
		weightkg: 30,
		color: "White",
		evoLevel: 33,
	...
	parabyte: {
		...
		name: "Parabyte",
		types: ["Bug", "Electric"],
		baseStats: {hp: 80, atk: 100, def: 60, spa: 80, spd: 60, spe: 105},
		abilities: {0: "Download", 1: "Levitate", H: "Transistor"},
		heightm: 10.6,
		weightkg: 86.7,
		prevo: "Wifly",
		color: "Green",
